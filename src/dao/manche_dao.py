...
class MancheDAO:
    ...
    def _dict_to_manche(data: dict) -> Manche:
        ...
        # On crée un InfoManche factice (à remplacer si tu veux restaurer les vraies infos)
        info = InfoManche([])  # si ton constructeur prend une liste de joueurs

        manche = Manche(info, grosse_blind)

        # Rétablir les attributs simples
